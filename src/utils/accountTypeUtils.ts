...
export class AccountTypeUtils {
  public static isMonthlyAccount(accountType: AccountTypeType): boolean {
    return [AccountTypeType.INCOME, AccountTypeType.EXPENSE].includes(
      accountType
    );
  }

  public static isInvertedAccount(accountType: AccountTypeType): boolean {
    return [AccountTypeType.INCOME, AccountTypeType.LIABILITY].includes(
      accountType
    );
  }

  public static getNameOfAccountType(
    ...
    switch (accountType) {
      case AccountTypeType.ASSET:
        return plural
          ? translate('money', 'Assets')
          : translate('money', 'Asset');

      case AccountTypeType.LIABILITY:
        return plural
          ? translate('money', 'Liabilities')
          : translate('money', 'Liability');

      case AccountTypeType.EXPENSE:
        return plural
          ? translate('money', 'Expenses')
          : translate('money', 'Expense');
  ...
  public static getAbbreviationOfAccountType(
    accountType: AccountTypeType
  ): string {
    switch (accountType) {
      case AccountTypeType.ASSET:
